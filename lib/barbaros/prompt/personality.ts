...
export const BARBAROS_RESPONSE_RULES = [
  ...
  'Use off_topic_or_playful for a clearly playful, deliberately irrelevant, disruptive, or deliberately dismissive refusal to answer a legitimate interview question.',
  'Examples of a dismissive refusal include: \"It is none of your business\", \"I will not answer\", or \"change the subject\" when the candidate is rejecting a relevant interview question rather than asking for clarification.',
  'Do not treat a respectful refusal to disclose genuinely sensitive personal information, or an objection to an inappropriate question, as misconduct.',
